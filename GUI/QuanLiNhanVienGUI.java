...
public class QuanLiNhanVienGUI extends RoundedPanel {
    ...
    public QuanLiNhanVienGUI() {
        ...
        ImageIcon search = new ImageIcon("C:\\Users\\Lenovo\\Downloads\\BanDoAnNhanh\\Image\\MagnifyingGlass.png");
        ...
        tableModel.addRow(new Object[]{"NV001", "Nguyễn Văn A", "Nhân viên", "Đang làm", "Sửa/Xóa"});
        ...
        tableModel.addRow(new Object[]{"NV012", "Ngô Tấn M", "Quản lý", "Đang làm", "Sửa/Xóa"});
